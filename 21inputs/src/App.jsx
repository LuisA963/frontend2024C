...
function App() {
  const [inputsForm, handleInputChange, formReset] = useForm ({
    username: "", password: "", checkbox: "", color: "",
    date: "", datetimelocal: "", email: "", file: "",
    hidden: "", image: "", month: "", number: "",radio: "",
    range: "", reset: "Restablecer", search: "", tel:"",
    time: "", url: "", week: "", button: "boton",
  })
      ...
      <form onSubmit={(e) => handleSubmit (e)}>
        ...
        <div>
          ...
          <input id="image"
           ...
           src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fes.wired.com%2Farticulos%2Falternativas-gratuitas-a-midjourney-para-crear-imagenes-con-ia-generativa&psig=AOvVaw1COyE1OyUxRzFOcXHP5vLm&ust=1717523869080000&source=images&opi=89978449"
